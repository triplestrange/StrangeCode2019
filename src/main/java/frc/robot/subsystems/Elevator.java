...
public class Elevator extends Subsystem implements PIDOutput {
	...
	//IS THERE A MAGENCODER?
	public static Encoder encoder = new Encoder(RobotMap.Elevator.MagEncoderPort1, RobotMap.Elevator.MagEncoderPort2);
	Joystick joy2;
	...
	public void move(Joystick joy2) {
		...
		if (joy2.getRawButtonPressed(1)) {
            ...
            //TODO: set the 2nd stage height on the second parameter (most likely the first hole/cargo hole)
