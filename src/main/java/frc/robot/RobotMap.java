...
public class RobotMap {
    ...
    public static class SwerveDrive {
        ...
        public static final double SWERVE_STEER_P = 0.9;
        public static final double SWERVE_STEER_I = 0.0005;
        public static final double SWERVE_STEER_D = .9;
        ...
        public final static double FL_ENC_OFFSET = 119;
        public final static double FR_ENC_OFFSET = 203;
        public final static double BL_ENC_OFFSET = 169;
        public final static double BR_ENC_OFFSET = 77;
