...
public class PathFollower {
    ...
    public PathFollower() {
        this.rotFollower = new ProfileFollower(0, 0, 0.008, 0, 0);
        this.parFollower = new ProfileFollower(.006, 0.00005, 0.075, 0, 0);
        this.perpFollower = new ProfileFollower(0, 0, 0.0125, 0, 0);
