...
public class FRCargoBackRocket extends CommandGroup {
    public FRCargoBackRocket() {
        ...
        addSequential(new PathCommand(-180, 180, 
                ...
                new SwerveWaypoint(-24, 100, Pathfinder.d2r(270), 90),
                new SwerveWaypoint(-24, 60, Pathfinder.d2r(270), 90)));
        addSequential(new SwerveDriveVisionForwardsAuto(1.75, 20));
        // addSequential(new HatchPistonGrab());
        // addSequential(new PathCommand(-24, 22, new SwerveWaypoint(-260, 22, Pathfinder.d2r(90), 90),
        //         new SwerveWaypoint(-24, 102, Pathfinder.d2r(90), 90),
        //         new SwerveWaypoint(-48, 227, Pathfinder.d2r(90), 60),
        //         new SwerveWaypoint(-34, 245, Pathfinder.d2r(150), 60),
        //         new SwerveWaypoint(-24, 262, Pathfinder.d2r(180), 120)));
        // addSequential(new SwerveDriveVisionForwardsAuto(2, 15));
        // addSequential(new HatchPistonPlace());
        // addSequential(new SwerveDriveVisionReverseAuto(1, 15));
